...
${point}                    //*[@id="header-top"]/div/div/div[3]/ul/li[3]/ul/li[3]/a
...
Click Button chat
    [Arguments]                  ${btn}
    Wait Until Element Is Visible   ${btn}  timeout=60
    Click Element                ${btn}
...
***Test Cases ***
แสดงสถานะการจัดส่ง Dek-D's Store Official ด้วย Chrome
