...
${btn_to_logout}                //li[@class='login-menu open']/ul[@class='dropdown-menu -right']/li[6]
***Keywords***
...
Click Login Button
    ...
    Click Element                ${btn}
Click Open Menu and Click to Logout
    [Arguments]                  ${btn}           ${btn_logout}    
    Element Should Be Visible    ${btn}
    Click Element                ${btn}
...
Logout- success
    ...
    Click Open Menu and Click to Logout    ${open_menu}                    ${btn_to_logout} 
